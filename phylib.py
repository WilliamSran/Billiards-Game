...
def phylib_square(cx):
    return _phylib.phylib_square(cx)

def poseq(pos, veloc, accel, time):
    return _phylib.poseq(pos, veloc, accel, time)

def veleq(vel, accel, time):
    return _phylib.veleq(vel, accel, time)
